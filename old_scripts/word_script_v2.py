...
def find_nearest_sentences(caption_data,caption_ids,prep_count,prep_idx,data,coco_all_images,new_words,coco_all_captions,side):
...
#./word2vec -train ../../Downloads/captions_train2014.txt -output testvec.txt -size=200 -window=5 -type=3 -iter=100000 -binary=0 -min-count=3 -sample=1e3 
...
prepositions = read_file('prepositions_verbs.csv',',') #Load prepositions
nouns = read_file('nouns.csv',',') #Load prepositions
...
caption_ids = np.load('captions_train2014ids.npy')
...
dm, preposition_word_matches, preposition_word_images, preposition_word_image_pointers, preposition_word_alt_image_pointers, preposition_word_parts, preposition_list, preposition_ids= \
	find_nearest_sentences(caption_data,caption_ids,prep_count,prep_idx,data,coco_all_images,new_words,my_captions,side);
